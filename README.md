...
Higher order component that provides the prop `theme` to a component.

```jsx
const Box = withTheme(({theme}) => {
...
| [<img src="https://avatars1.githubusercontent.com/u/662750?v=3" width="100px;"/><br /><sub>Kye Hohenberger</sub>](https://github.com/tkh44)<br /> |
