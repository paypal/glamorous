...
import {GlamorousComponent, GlamorousComponentProps} from 'glamorous/preact'

import {CSSPropertiesPseudo, CSSPropertiesLossy} from 'glamorous/preact'

// Glamorous built in Components named exports

import {Article, H1, P} from 'glamorous/preact'
...
class ClassToWrap extends Component<ClassToWrapProps, object> {
  render() {
...
const StatelessToWrap: FunctionalComponent<object> = () => <div />
...
const props: GlamorousComponentProps<JSX.HTMLAttributes> = {
  name: 'button',
  onClick: () => {},
}
...
const ComponentWithTheme: FunctionalComponent<Props> = props => (
  <h3
    style={{
...
import {Span, Div} from 'glamorous/preact'

const testDiv: JSX.Element = (
  <Div>
    <Div />
  </Div>
)
...
const CustomStatelessComponent: FunctionalComponent<{}> = _props => <div />
...
// Preact does not support fragments yet
