...
const TestDiv = glamorous.div(
  ...
  <TestDiv border="1px solid black" />

const TestDiv2 = glamorous(TestDiv)((props: {color: string}) => ({
  color: props.color,
}))
  <TestDiv2 color="red" border="asd" />
...
const TestDivWithMultipleDynamicStyles = glamorous.div(
  ...
  <TestDivWithMultipleDynamicStyles border="1px solid black" color="red" />
