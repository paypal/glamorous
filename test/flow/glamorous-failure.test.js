...
import glamorous, {ThemeProvider, withTheme, asd} from '../../src/' // wrong import asd
...
const TestDiv = glamorous.div(
  ...
  <TestDiv /> // Missing prop border

const TestDiv2 = glamorous(TestDiv)((props: {color: string}) => ({
  color: props.color,
}))
  <TestDiv2 border="asd" /> // Missing prop color
...
// Missing prop color
  <TestDivWithMultipleDynamicStyles border="1px solid black" />
...
// CSS props on GlamorousComponent
  <MyInput css={{zIndex: 'asd'}} /> // zIndex can only be number
...
const MyStyledSubTitle = withTheme(SubTitle)
  ...
  <SubTitle theme={someTheme} /> // theme props needed here
